...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Change Character', "Value 1: Character to change (Dad, BF, GF, DAD1, DAD2, DAD3)\nValue 2: New character's name"],
	...
	**/
	...
	override function create()
	{
		...
		\nZ/X - Zoom in/out
		\nNOTE: Spong Sing is Dad 3, Bob Sing is Dad 2, and Bambi Sing is Dad 1.
	...
	function addSongUI():Void
	{
		...
		var stepperSpeed:FlxUINumericStepper = new FlxUINumericStepper(1, stepperBPM.y + 35, 0.1, 1, 0.1, 10, 1);
		...
		var dad1DropDown = new FlxUIDropDownMenuCustom(-500, stepperSpeed.y + 115, FlxUIDropDownMenuCustom.makeStrIdLabelArray(characters, true), function(character:String)
			{
				_song.dad1 = characters[Std.parseInt(character)];
				updateHeads();
			});
			dad1DropDown.selectedLabel = _song.dad1;
			blockPressWhileScrolling.push(dad1DropDown);
		
		var dad2DropDown = new FlxUIDropDownMenuCustom(-500, stepperSpeed.y + 145, FlxUIDropDownMenuCustom.makeStrIdLabelArray(characters, true), function(character:String)
			{
		...
		var dad3DropDown = new FlxUIDropDownMenuCustom(-500, stepperSpeed.y + 175, FlxUIDropDownMenuCustom.makeStrIdLabelArray(characters, true), function(character:String)
			{
		...
		tab_group_song.add(new FlxText(dad1DropDown.x, dad1DropDown.y - 15, 0, 'Dad 1:'));
		...
		tab_group_song.add(dad1DropDown);
	...
	var check_spongSection:FlxUICheckBox;
	var check_bambiSection:FlxUICheckBox;
	var check_bobSection:FlxUICheckBox;
	...
	function addSectionUI():Void
	{
		...
		check_spongSection = new FlxUICheckBox(130, 120, null, null, "Dad 3 section", 100);
		check_spongSection.name = 'check_spong';
		check_spongSection.checked = _song.notes[curSection].spongSection;

		check_bambiSection = new FlxUICheckBox(130, 90, null, null, "Dad 1 section", 100);
		check_bambiSection.name = 'check_bambi';
		check_bambiSection.checked = _song.notes[curSection].bambiSection;

		check_bobSection = new FlxUICheckBox(130, 60, null, null, "Dad 2 section", 100);
		check_bobSection.name = 'check_bob';
		check_bobSection.checked = _song.notes[curSection].bobSection;
		...
		tab_group_section.add(check_bambiSection);
		tab_group_section.add(check_bobSection);
		tab_group_section.add(check_spongSection);
	...
	override function getEvent(id:String, sender:Dynamic, data:Dynamic, ?params:Array<Dynamic>)
	{
		if (id == FlxUICheckBox.CLICK_EVENT)
		{
			...
			switch (label)
			{
				...
				case 'Dad 3 section':
					_song.notes[curSection].spongSection = check.checked;
	
					updateGrid();
					updateHeads();
				case 'Dad 2 section':
					_song.notes[curSection].bobSection = check.checked;
	
					updateGrid();
					updateHeads();
				case 'Dad 1 section':
					_song.notes[curSection].bambiSection = check.checked;
	...
	function updateSectionUI():Void
	{
		...
		check_bambiSection.checked = sec.bambiSection;
		check_spongSection.checked = sec.spongSection;
		check_bobSection.checked = sec.bobSection;
